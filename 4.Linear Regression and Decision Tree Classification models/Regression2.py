...
train = pd.read_csv('PB2_train.csv', header=None)
test = pd.read_csv('PB2_test.csv', header=None)
...
print('Predicted values(y) on PB2_test.csv :', pred_y)
...
ax.set_ylabel('x2')
ax.set_zlabel('y')
ax.set_title('3-D Plot of PB2_test.csv')
